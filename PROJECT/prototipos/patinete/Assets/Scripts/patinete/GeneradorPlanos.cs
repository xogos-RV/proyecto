...
public class GeneradorPlanos : MonoBehaviour
{
    ...
    public float longitudPlano = 100f; // Longitud de cada plano
    public int numeroPlanosEnEscena = 4; // Número de planos que queremos mantener activos
